  ...
  return (
    <div className="space-y-8">
      <div className="border-b border-gray-100 pb-4 mb-6">
        <h3 className="text-2xl font-bold text-brand-navy">CIBIL Score Guide</h3>
        <p className="text-gray-500 font-medium text-sm mt-1">Understand your credit score and how it impacts your loan approval.</p>
      </div>

      {/* What is CIBIL */}
      <div className="bg-gray-50 border-2 border-brand-border rounded-xl p-6">
        <h3 className="text-brand-navy font-bold text-lg mb-3 flex items-center gap-2">
      ...
      {/* Score Ranges */}
      <div>
        <h3 className="text-brand-navy font-bold text-base mb-4 uppercase tracking-wider">
        ...
        <div className="grid md:grid-cols-2 gap-4">
          {scoreRanges.map((item) => (
            <div
              key={item.range}
              className={`${item.bgColor} border border-transparent hover:${item.borderColor} transition-colors rounded-xl p-5 shadow-sm`}
            >
              ...
              <div className="w-full h-2 bg-white rounded-full overflow-hidden mb-3 shadow-inner">
                <div
      ...
      {/* Low CIBIL Help */}
      <div className="bg-brand-navy rounded-xl p-6 text-white shadow-[var(--shadow-solid-sm)] flex flex-col sm:flex-row items-center gap-6">
        <div className="flex-1">
          <h3 className="font-bold text-xl mb-2 text-[#4ade80]">
        ...
        <a
          ...
          className="inline-flex items-center gap-2 bg-[#1b5e20] border-2 border-[#1b5e20] text-white font-bold px-6 py-3 rounded-xl hover:bg-[#144d18] transition-colors uppercase tracking-wider text-xs whitespace-nowrap"
        >
      ...
      <div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {tips.map((item) => (
            <div
              key={item.tip}
              className="flex items-start gap-3 bg-white border border-gray-200 rounded-xl p-4 shadow-sm hover:shadow-md transition-shadow"
            >
              <span className="text-xl flex-shrink-0">{item.icon}</span>
              <p className="text-brand-navy font-medium text-xs pt-1 leading-relaxed">{item.tip}</p>
            </div>
          ))}
        </div>
      </div>
